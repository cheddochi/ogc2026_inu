"""reboot_v212_20260627_trackA_reserved_specialist_budget_on_v210.py

Strategy:
    Preserve the trusted v210 Track A portfolio and runtime-cliff ordering, but
    reserve a small specialist budget earlier inside the stable four-bay Track A
    portfolio so the late residual repairs remain available on the official
    wrapper surface. The target remains the same narrow profitable subtype:
    mid-size four-bay high-urgency rows with residual first20 tardiness.
"""
