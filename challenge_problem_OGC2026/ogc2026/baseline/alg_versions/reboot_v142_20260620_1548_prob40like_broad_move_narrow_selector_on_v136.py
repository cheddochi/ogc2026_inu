...
Strategy:
    Keep trusted v136 as the default path, then replay the stronger four-bay
    top-tardy quantile move only on the narrow prob40-like tail.

Metadata:
    version_id: reboot_v142_20260620_1548_prob40like_broad_move_narrow_selector_on_v136
    parent_version: reboot_v136_20260620_2335_twobay_deeper_toptardy_on_v135
    status: candidate
    timestamp: 2026-06-20 15:48 KST
    strategy:
        - Preserve v136 unchanged outside the target subtype.
        - Build the exact v136 warm start first.
        - On the narrow prob40-like slice only, replay the stronger v124
          top-tardy quantile single-reinsert.
        - Keep only strictly better officially feasible results.
    hypothesis:
        The current v136 line still leaves a real prob40-like T drop that the
        broader v124 local move can recover, while the neighboring prob31-like
        family stays protected by the narrower v130-style selector.
    intended_metric_target:
        - improve the prob40-like high-T head
        - preserve accepted_for_score 40/40
        - lower total T / avg T / high-T tail before polish-only work
    validation_status:
        pending
